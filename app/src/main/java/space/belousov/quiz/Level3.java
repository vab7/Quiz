...
public class Level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialogfon.setBackgroundResource(R.drawable.ic_preview_bg3);

        TextView textlevel2 = dialog.findViewById(R.id.textDescription);
        textlevel2.setText(R.string.level3_text_preview);
        ...
        dialogfonEnd.setBackgroundResource(R.drawable.ic_preview_bg3);

        TextView textdescriptionEnd = dialogEnd.findViewById(R.id.textDescriptionEnd);
        textdescriptionEnd.setText(R.string.level3_text_end);
        ...
        img_left.setImageResource(array.img3[numLeft]);
        text_left.setText(array.text3[numLeft]);

        numRight = random.nextInt(21);
        while (numLeft == numRight)
            numRight = random.nextInt(21);
        img_right.setImageResource(array.img3[numRight]);
